            ...
            <form class="form-horizontal" method="post">
                ...
                <fieldset>
                     <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <input type="text" value="{{$sintoma->nombre}}" class="form-control" id="sintoma" name="nombre">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="descripcion" class="col-lg-2 control-label">Descripción</label>
                        <div class="col-lg-10">
                            <input type="text" value="{{$sintoma->descripcion}}" class="form-control" id="descripcion" name="descripcion">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <select name="estado" class="form-control" id="estado">
                                <option value="0" @if($sintoma->estado==0) selected  @endif >Inactivo</option>
                                <option value="1" @if($sintoma->estado==1) selected  @endif>Activo</option>
                            </select>

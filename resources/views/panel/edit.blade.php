                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-3">
                                                    <input type="number" class="form-control" id="edad_ing" name="edad_ing"
                                                           value="{!! $paciente->fecha_alta->diffInYears($paciente->fecha_nac) !!}" readonly>
                                                </div>
                                            </div>
                                            <div class="row">
                                                ...
                                                <div class="col-lg-3">
                                                    <input type="text" class="form-control" id="fecha_alta"
                                                           name="fecha_alta"
                                                           value="@if($paciente->fecha_alta != null){!! $paciente->fecha_alta->format('d/m/Y') !!} @endif" readonly>
                                                </div>
                                                ...
                                                <div class="col-lg-3">
                                                    <input type="number" class="form-control" id="anios_seg"
                                                           name="anios_seg"
                                                           value="{!! \Carbon\Carbon::now()->diffInYears($paciente->fecha_alta) !!}" readonly>
                                                </div>
                                            </div>
                                            <div class="row">
                                                ...
                                                <div class="col-lg-3">
                                                    <input type="text" class="form-control" id="fecha_ult_consulta"
                                                           ...
                                                           value="@if($paciente->fecha_ult_consulta){!! $paciente->fecha_ult_consulta->format('d/m/Y') !!} @endif" readonly>
                                                </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-4">
                                                <input type="text" class="form-control datepicker" id="fecha_cambio_gcli"
                                                       ...
                                                       value="@if($paciente->fecha_cambio_gcli !== null) {!! $paciente->fecha_cambio_gcli->format('d/m/Y') !!} @endif">
                                            </div>
                                        </div>
                                        <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4">
                                            <input type="text" class="form-control datepicker" id="fecha_ini_trat_bnz"
                                                   ...
                                                   value="@if($paciente->fecha_ini_trat_bnz != null){!! $paciente->fecha_ini_trat_bnz->format('d/m/Y') !!} @endif">
                                        </div>
                                    </div>
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4">
                                            <input type="text" class="form-control datepicker" id="fecha_ini_trat_nifur"
                                                   ...
                                                   value="@if($paciente->fecha_ini_trat_nifur != null){!! $paciente->fecha_ini_trat_nifur->format('d/m/Y') !!} @endif">
                                        </div>
                                    </div>
                                    <div class="row">
                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        ...
                                        <input type="text" class="form-control datepicker" id="fecha_rx_torax"
                                               name="fecha_rx_torax"
                                               value="@if($paciente->fecha_rx_torax != null){!! $paciente->fecha_rx_torax->format('d/m/Y') !!} @endif">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <label for="rx_torax"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4">
                                            <input type="text" class="form-control datepicker" id="fecha_cambios_rxt"
                                                   ...
                                                   value="@if($paciente->fecha_cambios_rxt != null){!! $paciente->fecha_cambios_rxt->format('d/m/Y') !!} @endif">
                                        </div>
                                    </div>
                                    <div class="row">

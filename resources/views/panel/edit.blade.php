                            ...
                            <div class="form-group">
                                <label for="grupo_clinico_ing" class="col-lg-6 control-label">Grupo Clínico al
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <option value="1" @if($paciente->grupo_clinico_ing==1) selected @endif>1</option>
                                        <option value="2" @if($paciente->grupo_clinico_ing==2) selected @endif>2</option><option value="3" @if($paciente->grupo_clinico_ing==3) selected @endif>3</option><option value="4" @if($paciente->grupo_clinico_ing==4) selected @endif>4</option><option value="5" @if($paciente->grupo_clinico_ing==5) selected @endif>5</option>
                                    </select>
                                    ...
                                    <div class="form-group">
                                        <label for="nuevo_grupo_cli" class="col-lg-6 control-label">Nuevo Grupo
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <option value="1" @if($paciente->nuevo_grupo_cli==1) selected @endif>1</option>
                                                <option value="2" @if($paciente->nuevo_grupo_cli==2) selected @endif>2</option>                                                    <option value="3" @if($paciente->nuevo_grupo_cli==3) selected @endif>3</option>                                                    <option value="4" @if($paciente->nuevo_grupo_cli==4) selected @endif>4</option>                                                    <option value="5" @if($paciente->nuevo_grupo_cli==5) selected @endif>5</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                                                                                                                                        ...
                                                                                                                                                        <div class="form-group">
                                                                                                                                                            <label for="indice_cardiotorax" class="col-lg-8 text-left {{--control-label --}}">Índice
                                                                                                                                                                ...
                                                                                                                                                                <div class="col-lg-4">
                                                                                                                                                                    ...
                                                                                                                                                                    <select class="form-control" id="indice_cardiotorax"
                                                                                                                                                                    name="indice_cardiotorax">

                                                                                                                                                                    @for($i=1;$i<15;$i++)
                                                                                                                                                                    <option value="{{$i}}" @if($paciente->indice_cardiotorax==$i) selected @endif>{{$i}}</option>
                                                                                                                                                                    @endfor
                                                                                                                                                                </select>
                                                                                                                                                            </div>
                                                                                                                                                        </div>

                  ...
                  <div class="portlet box blue">
                     ...
                     <div class="portlet-body">
                        <div class="row">
                           ...
                           <div class="col-lg-3">
                              <input type="text" style="text-transform: uppercase"  class="form-control" id="apellido" name="apellido" value="{!! old('apellido') !!}">
                           </div>
                           <label for="nombre" class="col-lg-2 text-left{{-- control-label --}}">Nombre/s</label>
                           <div class="col-lg-3">
                              <input type="text" style="text-transform: uppercase"  class="form-control" id="nombre" name="nombre" value="{!! old('nombre') !!}">
                           </div>
                        </div>
                     </div>
                  </div>
            ...
            <div class="row">
               ...
               <div class="col-lg-6">
                  ...
                  <div class="col-lg-6">
                     <div class="portlet box blue">
                        <div class="portlet-title">
                           <div class="caption">Estado del paciente</div>
                        </div>
                        <div class="portlet-body">
                           <div class="row">
                  ...
                  <div class="portlet box blue">
                     ...
                     <div class="portlet-body">
                        ...
                        <div class="form-group">
                           ...
                           <div class="col-lg-4">
                              <input  id="indice_cardiotorax" class="form-control" name="indice_cardiotorax" type="number"  step="0.01" />
                           </div>
                        </div>
                        <div class="form-group">
                           <label for="obs_rxt"
...
>>>>>>> 4ce26220c15e2f9bb91645aa39ba2194bf4b34f7
@endsection
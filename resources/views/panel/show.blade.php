                             ...
                             <div class="panel panel-default">
                                <div class="panel-body">
                                    <div class="row  ">
                                        ...
                                        <div class="col-lg-2">Tipo Documento <b class="value">{!! $paciente->tipo_doc !!}</b>
                                        </div>
                                    ...
                                    <div class="portlet box blue">
                                        ...
                                        <div class="portlet-body">
                                            <div class="row static-info">
                                                <span for="fecha_nac" data-field="fecha_nac" class="col-lg-3  ">Fecha Nac.</span>
                                            ...
                                            <div class="row static-info">
                                                <span for="fecha_alta" class="col-lg-3  ">Fecha
                                                    Ing.</span>
                                                <div class="col-lg-3 value">
